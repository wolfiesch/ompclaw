...
Branch protection requires the stable `verify` check. Before merging, confirm that the latest automated review commit matches the current pull-request head and that all review threads are resolved.
