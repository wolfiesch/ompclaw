...
export const RUNTIME_COMMANDS: readonly RuntimeCommandDefinition[] = [
  ...
  { command: "task_recover", description: "Inspect, continue, or explicitly restart a task", group: "Work" },
  { command: "task_diff", description: "View the authorized task project diff", group: "Work" },
  { command: "task_artifact", description: "Download an authorized task artifact", group: "Work" },
  { command: "projects", description: "List authorized projects", group: "Work", native: true },
  { command: "project", description: "Show or select the active project", group: "Work", native: true },
  { command: "scope", description: "Narrow the next project task scope", group: "Work" },
